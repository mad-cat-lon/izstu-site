...
export default function Home() {
      ...
      <div className="min-h-screen bg-white p-7 pl-19">
        ...
        <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-3 gap-12">
          ...
          <div id="projects" className="max-w-7xl mx-auto mt-24">
            <header className="mb-12 -ml-19">
          ...
          <div id="works" className="max-w-7xl mx-auto mt-24">
            <header className="mb-12 -ml-19">
          ...
          <div id="about" className="max-w-7xl mx-auto mt-24">
            <header className="mb-12 -ml-19">
